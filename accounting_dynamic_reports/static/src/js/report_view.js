        ...
        */
        ...
        //creating columns with styles based on the type
            ...
            if(rec['type'] == 'journal_item'){
                var style = "font-size:15px;padding-left:55px!important;";
                attr += " style="+style;
                //add name
                temp_str += "<td class='child_col_name' "+attr+" >"+rec['name'] + "</td>";
                //add balance
                temp_str += "<td class='child_col_bal' "+attr+" >"+rec['balance']+"</td><td class='child_col_bal' "+attr+"></td></tr>";
            }
            else {
                var style = "font-size:20px;font-weight:bold!important;padding-left:" + rec['level'] * 7 + "px!important;";
                attr += " style="+style;
                //add name
                temp_str += "<td class='child_col_name' "+attr+" >"+rec['name'] + "</td>";
                //add balance
                temp_str += "<td class='child_col_bal' "+attr+"></td><td class='child_col_bal' "+attr+" >"+rec['balance']+"</td></tr>";
            }
            return temp_str;
        },
